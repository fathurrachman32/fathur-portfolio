...
<head>
  <title>Alumni Kampus Merdeka - Gobel Group</title>
  <meta charset="utf-8">
  ...
  <meta name="keywords" content="Alumni, Kampus Merdeka, Gobel Group, Career, Network">
  <meta name="description" content="Website Alumni Kampus Merdeka Gobel Group - Jaringan dan peluang karir bagi alumni program Kampus Merdeka di Gobel Group.">
          ...
          <section id="about" class="my-5 py-5" data-aos="fade-up">
            ...
            <div class="row d-flex flex-wrap">
              <div class="col-lg-12 pb-5">
                <h1 class="display-4 txt-fx slide-up">Alumni Kampus Merdeka - Gobel Group</h1>
              </div>
            </div>
            <div class="row">
                ...
                <div data-aos="fade-up" data-aos-delay="200">
                  <ul class="list-unstyled">
                    <li>
                      <h5>Website Link</h5>
                      <p>
                        <a href="https://alumni.gobel.co.id/" 
                           target="_blank" 
                           class="highlighted-link">
                          Kunjungi Website Alumni Kampus Merdeka - Gobel Group
                        </a>
                      </p>
                    </li>
                  </ul>
              ...
              <div class="col-lg-6 pb-5">
                <div class="fs-5" data-aos="fade-up" data-aos-delay="300">
                  <p><strong>Alumni Kampus Merdeka - Gobel Group</strong> adalah platform yang menghubungkan para alumni program Kampus Merdeka yang telah menjalani pengalaman kerja di Gobel Group. Website ini memberikan akses ke berbagai kesempatan karir, networking, dan berbagi pengalaman dalam dunia profesional.</p>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/alumni1.png" alt="Alumni Portal" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/alumni2.png" alt="Networking Event" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/alumni3.png" alt="Career Opportunity" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
