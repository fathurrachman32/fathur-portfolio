...
<head>
  <title>Projectseratusjuta - Content and Design</title>
  <meta charset="utf-8">
  ...
  <meta name="keywords" content="Investasi Saham, Projectseratusjuta, Trading, Finansial, Keuangan">
  <meta name="description" content="Projectseratusjuta adalah platform edukasi dan informasi tentang investasi saham, strategi trading, dan manajemen keuangan.">
  ...
  <style>
    ...
    .highlighted-link:hover {
        color: #ff5722;
        text-shadow: 0px 0px 8px rgba(255, 87, 34, 0.8);
    }

    /* Styling untuk gambar Instagram-style */
    .portfolio-image figure img {
        width: 100%;
        height: 600px; /* Sesuai dengan tampilan post Instagram terbaru */
        object-fit: cover;
        border-radius: 8px;
    }
          ...
          <section id="about" class="my-5 py-5" data-aos="fade-up">
            ...
            <div class="row d-flex flex-wrap">
              <div class="col-lg-12 pb-5">
                <h1 class="display-4 txt-fx slide-up">Projectseratusjuta - Content and Design</h1>
              </div>
            </div>
            <div class="row">
                ...
                <div data-aos="fade-up" data-aos-delay="200">
                  <ul class="list-unstyled">
                    <li>
                      ...
                      <p>
                        <a href="https://www.instagram.com/projectseratusjuta/" 
                           target="_blank" 
                           class="highlighted-link">
                          Lihat Projectseratusjuta di Instagram
                        </a>
                      </p>
                    </li>
                  </ul>
              ...
              <div class="col-lg-6 pb-5">
                <div class="fs-5" data-aos="fade-up" data-aos-delay="300">
                  <p><strong>Projectseratusjuta</strong> adalah platform edukasi investasi saham yang memberikan wawasan mendalam tentang strategi trading, analisis pasar, dan manajemen portofolio. Dengan fokus pada investasi jangka panjang, platform ini membantu investor memahami cara mengelola risiko dan meningkatkan keuntungan mereka di pasar modal.</p>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/seratusjuta1.png" alt="Tips Investasi Saham" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/seratusjuta2.png" alt="Analisis Pasar" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/seratusjuta3.png" alt="Manajemen Risiko" class="img-fluid">
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/seratusjuta4.png" alt="Manajemen Risiko" class="img-fluid">
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/seratusjuta5.png" alt="Manajemen Risiko" class="img-fluid">
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/seratusjuta6.png" alt="Manajemen Risiko" class="img-fluid">
                </div>
              </div>
            </div>
