...
<head>
  <title>Metaquestion Roblox</title>
  <meta charset="utf-8">
  ...
  <meta name="keywords" content="Metaquestion, Roblox, Game, Educational">
  <meta name="description" content="Metaquestion - A Roblox game that makes learning fun through interactive gameplay.">
          ...
          <section id="about" class="my-5 py-5" data-aos="fade-up">
            ...
            <div class="row d-flex flex-wrap">
              <div class="col-lg-12 pb-5">
                <h1 class="display-4 txt-fx slide-up">Metaquestion Roblox</h1>
              </div>
            </div>
            <div class="row">
                ...
                <div data-aos="fade-up" data-aos-delay="200">
                  <ul class="list-unstyled">
                    <li>
                      <h5>Game Link</h5>
                      <p>
                        <a href="https://www.roblox.com/games/11262612189/Metaquestion" 
                           target="_blank" 
                           class="highlighted-link">
                          Play Metaquestion on Roblox
                        </a>
                      </p>
                    </li>
                  </ul>
              ...
              <div class="col-lg-6 pb-5">
                <div class="fs-5" data-aos="fade-up" data-aos-delay="300">
                  <p><strong>Metaquestion</strong> adalah sebuah game edukasi di platform Roblox yang menggabungkan <em>gameplay</em> interaktif dengan soal-soal untuk menguji dan meningkatkan pengetahuan pemain. Dalam permainan ini, pemain dapat menjawab berbagai pertanyaan sambil menyelesaikan tantangan unik, membuat belajar menjadi lebih menyenangkan dan efektif.</p>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/metaquestion1.png" alt="Metaquestion Gameplay" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/metaquestion2.png" alt="Metaquestion Environment" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/metaquestion3.png" alt="Metaquestion UI Design" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
