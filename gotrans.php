...
<head>
  <title>GoTrans Logistics International</title>
  <meta charset="utf-8">
  ...
  <meta name="keywords" content="GoTrans Logistics, International Logistics, Freight Forwarding, Supply Chain">
  <meta name="description" content="Profil perusahaan GoTrans Logistics International, penyedia layanan logistik global yang efisien dan terintegrasi.">
          ...
          <section id="about" class="my-5 py-5" data-aos="fade-up">
            ...
            <div class="row d-flex flex-wrap">
              <div class="col-lg-12 pb-5">
                <h1 class="display-4 txt-fx slide-up">GoTrans Logistics International</h1>
              </div>
            </div>
            <div class="row">
                ...
                <div data-aos="fade-up" data-aos-delay="200">
                  <ul class="list-unstyled">
                    <li>
                      <h5>Website Link</h5>
                      <p>
                        <a href="https://gotrans-logistics.co.id/" 
                           target="_blank" 
                           class="highlighted-link">
                          Kunjungi Website GoTrans Logistics
                        </a>
                      </p>
                    </li>
                  </ul>
              ...
              <div class="col-lg-6 pb-5">
                <div class="fs-5" data-aos="fade-up" data-aos-delay="300">
                  <p><strong>GoTrans Logistics International</strong> adalah penyedia layanan logistik global yang menawarkan solusi terintegrasi untuk pengelolaan rantai pasokan, pengiriman barang, dan layanan pergudangan. Dengan teknologi canggih dan jaringan internasional, GoTrans memastikan efisiensi dalam pengiriman serta kepuasan pelanggan.</p>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/gotrans1.png" alt="Warehouse Logistics" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/gotrans2.png" alt="International Freight" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/gotrans3.png" alt="Supply Chain Optimization" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/gotrans4.png" alt="Supply Chain Optimization" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
