...
<head>
  <title>GI Portal - Office 365</title>
  <meta charset="utf-8">
  ...
  <meta name="keywords" content="GI Portal, Office 365, Digital Workplace, Productivity">
  <meta name="description" content="GI Portal - Office 365 adalah sistem yang mengintegrasikan layanan Microsoft Office 365 ke dalam portal Gobel International.">
          ...
          <section id="about" class="my-5 py-5" data-aos="fade-up">
            ...
            <div class="row d-flex flex-wrap">
              <div class="col-lg-12 pb-5">
                <h1 class="display-4 txt-fx slide-up">GI Portal - Office 365</h1>
              </div>
            </div>
            <div class="row">
                ...
                <div data-aos="fade-up" data-aos-delay="200">
                  <ul class="list-unstyled">
                    <li>
                      <h5>Website Link</h5>
                      <p>
                        <a href="https://apps.powerapps.com/play/e/default-e878063b-8d00-4661-bb5e-2cb2a7ae710e/a/60a893bf-2efe-4bdb-aae3-703ff0b00280?tenantId=e878063b-8d00-4661-bb5e-2cb2a7ae710e&hint=c268c47b-5411-4ead-ace4-47e37cf839ce&sourcetime=1710390065699" 
                           target="_blank" 
                           class="highlighted-link">
                          Kunjungi GI Portal - Office 365
                        </a>
                      </p>
                    </li>
                  </ul>
              ...
              <div class="col-lg-6 pb-5">
                <div class="fs-5" data-aos="fade-up" data-aos-delay="300">
                  <p><strong>GI Portal - Office 365</strong> adalah sistem yang mengintegrasikan berbagai layanan Microsoft Office 365 ke dalam ekosistem digital Gobel International. Platform ini membantu kolaborasi tim, komunikasi yang lebih efektif, dan manajemen dokumen berbasis cloud untuk meningkatkan produktivitas kerja.</p>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/3651.png" alt="Dashboard Office 365" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/3652.png" alt="Collaboration Tools" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/3653.png" alt="Document Management" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
