...
<head>
  <title>Website - ECommerce Warung Fathur</title>
  <meta charset="utf-8">
  ...
  <meta name="keywords" content="ECommerce, Warung Fathur, Online Store, UMKM, Marketplace">
  <meta name="description" content="Website ECommerce Warung Fathur - Platform belanja online untuk produk UMKM dengan konsep digitalisasi warung tradisional.">
  ...
  <style>
    ...
    /* Styling untuk gambar tampilan website */
    .portfolio-image figure img {
        width: 100%;
        height: 600px; /* Tampilan portrait */
        object-fit: cover;
        border-radius: 8px;
    }
          ...
          <section id="about" class="my-5 py-5" data-aos="fade-up">
            ...
            <div class="row d-flex flex-wrap">
              <div class="col-lg-12 pb-5">
                <h1 class="display-4 txt-fx slide-up">Website - ECommerce Warung Fathur</h1>
              </div>
            </div>
            <div class="row">
                ...
                <div data-aos="fade-up" data-aos-delay="200">
                  <ul class="list-unstyled">
                    <li>
                      <h5>Website Link</h5>
                      <p>
                        <a href="https://warungfathur.pythonanywhere.com/" 
                           target="_blank" 
                           class="highlighted-link">
                          Kunjungi ECommerce Warung Fathur
                        </a>
                      </p>
                    </li>
                  </ul>
              ...
              <div class="col-lg-6 pb-5">
                <div class="fs-5" data-aos="fade-up" data-aos-delay="300">
                  <p><strong>Warung Fathur</strong> adalah platform e-commerce yang bertujuan untuk mendigitalisasi warung tradisional, memungkinkan pemilik warung menjual produk mereka secara online. Dengan sistem yang mudah digunakan dan terintegrasi, Warung Fathur membantu UMKM meningkatkan penjualan dan menjangkau lebih banyak pelanggan.</p>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/warungfathur1.jpg" alt="Tampilan Homepage Warung Fathur" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/warungfathur2.png" alt="Halaman Produk" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/warungfathur3.png" alt="Checkout dan Pembayaran" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/warungfathur4.png" alt="Checkout dan Pembayaran" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/warungfathur5.jpg" alt="Checkout dan Pembayaran" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/warungfathur7.jpg" alt="Checkout dan Pembayaran" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
