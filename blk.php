...
<head>
  <title>Website - Balai Latihan Kerja Gobel Group</title>
  <meta charset="utf-8">
  ...
  <meta name="keywords" content="Balai Latihan Kerja, Gobel Group, Pelatihan Kerja, Keahlian, Industri">
  <meta name="description" content="Balai Latihan Kerja Gobel Group menyediakan pelatihan berbasis industri untuk meningkatkan keterampilan tenaga kerja profesional.">
          ...
          <section id="about" class="my-5 py-5" data-aos="fade-up">
            ...
            <div class="row d-flex flex-wrap">
              <div class="col-lg-12 pb-5">
                <h1 class="display-4 txt-fx slide-up">Website - Balai Latihan Kerja Gobel Group</h1>
              </div>
            </div>
            <div class="row">
                ...
                <div data-aos="fade-up" data-aos-delay="200">
                  <ul class="list-unstyled">
                    <li>
                      <h5>Website Link</h5>
                      <p>
                        <a href="https://goservices.gobel.co.id/" 
                           target="_blank" 
                           class="highlighted-link">
                          Kunjungi Website Balai Latihan Kerja Gobel Group
                        </a>
                      </p>
                    </li>
                  </ul>
              ...
              <div class="col-lg-6 pb-5">
                <div class="fs-5" data-aos="fade-up" data-aos-delay="300">
                  <p><strong>Balai Latihan Kerja Gobel Group</strong> menyediakan program pelatihan berbasis industri untuk meningkatkan keterampilan tenaga kerja di berbagai sektor. Dengan fasilitas modern dan kurikulum yang dirancang sesuai kebutuhan industri, program ini membantu peserta mengembangkan kompetensi dan siap bersaing di dunia kerja.</p>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/blk1.png" alt="Pelatihan Teknik HVAC" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/blk2.png" alt="Workshop Keahlian Teknologi" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/blk3.png" alt="Sertifikasi Profesi" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/blk4.png" alt="Sertifikasi Profesi" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/blk5.png" alt="Sertifikasi Profesi" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
