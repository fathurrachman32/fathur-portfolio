...
<head>
  <title>KKN 102 SAMUDRA UMP - Instagram Profile</title>
  <meta charset="utf-8">
  ...
  <meta name="keywords" content="KKN 102, Samudra UMP, Universitas Muhammadiyah, Instagram">
  <meta name="description" content="Profil Instagram resmi KKN 102 Samudra Universitas Muhammadiyah Purwokerto, dokumentasi kegiatan pengabdian masyarakat.">
          ...
          <section id="about" class="my-5 py-5" data-aos="fade-up">
            ...
            <div class="row d-flex flex-wrap">
              <div class="col-lg-12 pb-5">
                <h1 class="display-4 txt-fx slide-up">KKN 102 SAMUDRA - Instagram Profile</h1>
              </div>
            </div>
            <div class="row">
                ...
                <div data-aos="fade-up" data-aos-delay="200">
                  <ul class="list-unstyled">
                    <li>
                      ...
                      <p>
                        <a href="https://www.instagram.com/kkn_samudra_ump/" 
                           target="_blank" 
                           class="highlighted-link">
                          Lihat KKN 102 Samudra di Instagram
                        </a>
                      </p>
                    </li>
                  </ul>
              ...
              <div class="col-lg-6 pb-5">
                <div class="fs-5" data-aos="fade-up" data-aos-delay="300">
                  <p><strong>KKN 102 SAMUDRA</strong> adalah program pengabdian masyarakat dari Universitas Muhammadiyah Purwokerto yang berfokus pada pembangunan desa dan peningkatan kesejahteraan masyarakat melalui berbagai kegiatan edukatif, sosial, dan ekonomi.</p>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/kkn1.png" alt="Kegiatan KKN 102 SAMUDRA" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/kkn2.png" alt="Kegiatan Sosial KKN" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/kkn3.png" alt="Pemberdayaan UMKM Desa" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/kkn4.png" alt="Pemberdayaan UMKM Desa" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
