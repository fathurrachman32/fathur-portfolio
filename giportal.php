...
<head>
  ...
  <meta name="keywords" content="GI Portal, Gobel International, Digital, Web Platform">
  <meta name="description" content="Website GI Portal - Sistem digitalisasi untuk meningkatkan efisiensi operasional di Gobel International.">
          ...
          <section id="about" class="my-5 py-5" data-aos="fade-up">
            ...
            <div class="row d-flex flex-wrap">
              <div class="col-lg-12 pb-5">
                <h1 class="display-4 txt-fx slide-up">Website - GI Portal</h1>
              </div>
            </div>
            <div class="row">
                ...
                <div data-aos="fade-up" data-aos-delay="200">
                  <ul class="list-unstyled">
                    <li>
                      <h5>Website Link</h5>
                      <p>
                        <a href="https://www.giportal.com" 
                           target="_blank" 
                           class="highlighted-link">
                          Kunjungi Website GI Portal
                        </a>
                      </p>
                    </li>
                  </ul>
              ...
              <div class="col-lg-6 pb-5">
                <div class="fs-5" data-aos="fade-up" data-aos-delay="300">
                  <p><strong>GI Portal</strong> adalah sistem digitalisasi yang dikembangkan untuk meningkatkan efisiensi operasional di Gobel International. Platform ini menyediakan berbagai fitur untuk mengelola dokumen, komunikasi internal, serta akses cepat ke berbagai layanan perusahaan.</p>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/portal1.png" alt="Dashboard GI Portal" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="portfolio-image py-3">
                  <figure>
                    <img src="images/portal2.png" alt="Fitur Manajemen Dokumen" class="img-fluid">
                  </figure>
                </div>
              </div>
            </div>
